...
Modeling.m --- This is a program to build a red giant star age estimation model using BP neural network training data, which uses (1:Teff,2:logg,3:[Fe/H],4:¦Ímax, 5:delta ¦Í) as input parameters.

Optimal_model.mat --- This is the best red giant age estimation model structure obtained when using (1:Teff,2:logg,3:[Fe/H],4:¦Ímax, 5:delta ¦Í) as input parameters.
